...
def help():
    ...
    After you press the Google It button it launches your default browser and types in the query you enter here.\n\n
    ...
    https://github.ziad/ziadh/Desky if you would like to make sure for yourself.
    THIS PROJECT IS NOT AFFILIATED WITH GOOGLE
    '''
    show_help = messagebox.showinfo('Google Search Help', message=help_message)
...
app.title(f'Google Search v{version}')

top_title = CTk.CTkLabel(
    app, text='Welcome To Google Search!', font=("Arial", 20))
...
submit_button = CTk.CTkButton(app, text='Google It!', command=search)
